...
class ProductController extends Controller
{
    ...
    ->get();
        ...
        return view('pages.shop', compact('shop','g_setting','products','categories','product_items_no_pagi','subCategories', 'categoriesWithSubCategories'));
    }
    ...
    public function detail1($slug)
    {
        ...
        return view('pages.product_detail', compact('g_setting','product_detail','product_items','product_items_no_pagi','categories'));
    }
