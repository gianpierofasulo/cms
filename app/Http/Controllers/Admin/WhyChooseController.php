...
class WhyChooseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'photo' => 'required|image|mimes:jpeg,png,jpg,gif,svg,webp,tiff,tif,psd|max:982048'
        ]);
    ...
    if($request->hasFile('photo')) {
        $request->validate([
            ...
            'photo' => 'image|mimes:jpeg,png,jpg,gif,svg,webp,tiff,tif,psd|max:982048'
        ]);
        if ($why_choose->photo != null) {
            $photoPath = public_path('uploads/' . $why_choose->photo);
