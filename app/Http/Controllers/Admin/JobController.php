...
class JobController extends Controller
{
    ...
    public function index()
    {
        ...
        $job = Job::orderBy('job_order')->get();
        return view('admin.job.index', compact('job'));
    }
 
    public function create()
    {
         $job_categor=DB::table('job_categories')->get();
        return view('admin.job.create', compact('job_categor'));
    ...
    public function edit($id)
    {
        ...
        return view('admin.job.edit', compact('job','job_category'));
