...
class DynamicPageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'dynamic_page_banner' => 'required|image|mimes:jpeg,png,jpg,gif,tiff,psd,psb|max:999992048'
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->hasFile('dynamic_page_banner')) {
            $request->validate([
                ...
                'dynamic_page_banner' => 'image|mimes:jpeg,png,jpg,gif,tiff,psd,psb|max:999992048'
            ]);
            if ($dynamic_page->dynamic_page_banner != null) {
                $photoPath = public_path('uploads/' . $dynamic_page->dynamic_page_banner);
