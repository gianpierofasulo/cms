        ...
        <div class="row team pt_0 pb_40">
             ...
             <div class="col-md-12">
                <div class="heading wow fadeInUp">
                    ...
                    <h3 class="text-center text-uppercase"> Senior Management</h3>
                </div>
            </div>
             @endif
              @endforeach
            @foreach($senior as $row)
            @if($row->category_id == '1')
            <div style="justify-content: center;" class="col-md-5 wow fadeInUp mx-auto d-block">
                ...
                <div class="team-text">
                    ...
                    <p>{{ $row->designation }}</p>
                    <p><b>{{__('Address')}} </b>{!! nl2br(e($row->address)) !!} </p>
                    <p><b>{{__('Email Address')}}</b> {{ $row->email }}</p>
                    <p><b>{{__('Phone Number')}}</b> {{ $row->phone }}</p>
            ...
            <div style="justify-content: center;" class="col-md-4 wow fadeInUp mx-auto d-block">
                     <div class="feature-item wow fadeInUp card">
                            <div class="team-photo">
                    <a href="{{ url('senior/'.$row->slug) }}" class="team-photo-anchor">
                        <img style="border-radius: 50%; width: 200px;height: 200px; display: block; margin-left: auto; margin-right: auto;" src="{{ asset('public/uploads/'.$row->photo) }}" alt="senior management photo">
            ...
            <div class="row">
             ...
             @endif
              @endforeach
            @foreach($senior as $row)
            @if($row->category_id == '5' || $row->category_id == '6')
            <div style="justify-content: center;" class="col-md-4 wow fadeInUp mx-auto d-block">
                     <div class="feature-item wow fadeInUp card">
                            <div class="team-photo">
                    <a href="{{ url('senior/'.$row->slug) }}" class="team-photo-anchor">
