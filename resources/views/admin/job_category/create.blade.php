...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Add Job Category</h1>

    <form action="{{ route('admin.job_category.store') }}" method="post">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Add Job Category</h6>
