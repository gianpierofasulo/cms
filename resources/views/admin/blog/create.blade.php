    ...
    <form action="{{ route('admin.blog.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="">Want to Post on telegram channel? *</label>
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="post_on_telegram_channel" id="pp1" value="1" checked>
                            <label class="form-check-label font-weight-normal" for="pp1">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="post_on_telegram_channel" id="pp2" value="0">
                            <label class="form-check-label font-weight-normal" for="pp2">No</label>
                        </div>
                    </div>
                </div>
