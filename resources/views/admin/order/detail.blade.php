                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><div class="input-group-append">
                                    ...
                                    &nbsp;&nbsp;
                                    @if($order_detail->card_last4 == 'offline')
                                @if($order_detail->payment_status == 'Completed')
                                    <a href="{{ URL::to('admin/order/make-pending/'.$order_detail->id) }}" class="btn btn-secondary btn-sm btn-" onClick="return confirm('Are you sure?');">Make Pending</a>
                                @else
                                    <a href="{{ URL::to('admin/order/make-active/'.$order_detail->id) }}" class="btn btn-secondary btn-sm btn-" onClick="return confirm('Are you sure?');">Make Completed</a>
                                @endif
                                @endif
                            </div>
                                </td>
