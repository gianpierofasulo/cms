...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Add Board Directors</h1>

    <form action="{{ route('admin.board_director.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Add Board Directors</h6>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <ul class="nav nav-pills mb-3 nav-doctor" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn-primary" id="pills-tab-2" data-toggle="pill" href="#pills-t-2" role="tab" aria-controls="pills-t-2" aria-selected="false">{{__('Click to Add Board massages')}}</a>
                        </li>
                    ...
                    <div class="tab-content nav-doctor-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="pills-t-2" role="tabpanel" aria-labelledby="pills-tab-2">
                            ...
                            <textarea name="board_message" class="form-control editor" cols="30" rows="10">{{ old('board_message') }}</textarea>
                        </div>
                    </div>
                </div>
