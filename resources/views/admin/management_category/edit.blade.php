...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Edit Management Category</h1>

    <form action="{{ url('admin/management_category/update/'.$category->id) }}" method="post">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Edit Management Category</h6>
                <div class="float-right d-inline">
                    <a href="{{ route('admin.management_category.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> View All</a>
                </div>
            </div>
            <div class="card-body">
