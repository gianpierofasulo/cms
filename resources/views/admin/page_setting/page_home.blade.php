            ...
            <div class="row">
                <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-11-tab" data-toggle="pill" href="#v-pills-11" role="tab" aria-controls="v-pills-11" aria-selected="false">Partner Section</a>

                        <a class="nav-link" id="v-pills-12-tab" data-toggle="pill" href="#v-pills-12" role="tab" aria-controls="v-pills-12" aria-selected="false">Senior Section</a>
                        <a class="nav-link" id="v-pills-13-tab" data-toggle="pill" href="#v-pills-13" role="tab" aria-controls="v-pills-13" aria-selected="false">Board Section</a>
                        <a class="nav-link" id="v-pills-14-tab" data-toggle="pill" href="#v-pills-14" role="tab" aria-controls="v-pills-14" aria-selected="false">Document Section</a>

                        <a class="nav-link" id="v-pills-16-tab" data-toggle="pill" href="#v-pills-16" role="tab" aria-controls="v-pills-16" aria-selected="false">About us Section</a>
                        <a class="nav-link" id="v-pills-16-tab" data-toggle="pill" href="#v-pills-16" role="tab" aria-controls="v-pills-16" aria-selected="false">Counter Section</a>
                    </div>
                </div>
                <div class="col-9">
                    <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
                            <!-- Tab 2 -->
                            <form action="{{ url('admin/page/home/2') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="">Title</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div><img src="{{ asset('public/uploads/'.$page_home->why_choose_bg) }}" alt="" class="w_200"></div>
                                </div>
                                <div class="form-group">
                                    <label for="">Change Background</label>
                                    <div><input type="file" name="why_choose_bg"></div>
                                </div> 
                        ...
                        <div class="tab-pane fade" id="v-pills-11" role="tabpanel" aria-labelledby="v-pills-11-tab">
                            ...
                            <form action="{{ url('admin/page/home/11') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="">Title</label>
                                    <input type="text" name="partner_title" class="form-control" value="{{ $page_home->partner_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Subtitle</label>
                                    <input type="text" name="partner_subtitle" class="form-control" value="{{ $page_home->partner_subtitle }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Status</label>
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="partner_status" id="rr1" value="Show" @if($page_home->partner_status == 'Show') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr1">Show</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="partner_status" id="rr2" value="Hide" @if($page_home->partner_status == 'Hide') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr2">Hide</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-12" role="tabpanel" aria-labelledby="v-pills-12-tab">
                            ...
                            <form action="{{ url('admin/page/home/12') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="">Title</label>
                                    <input type="text" name="senior_title" class="form-control" value="{{ $page_home->senior_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Subtitle</label>
                                    <input type="text" name="senior_subtitle" class="form-control" value="{{ $page_home->senior_subtitle }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Status</label>
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="senior_status" id="rr1" value="Show" @if($page_home->senior_status == 'Show') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr1">Show</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="senior_status" id="rr2" value="Hide" @if($page_home->senior_status == 'Hide') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr2">Hide</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-13" role="tabpanel" aria-labelledby="v-pills-13-tab">
                            ...
                            <form action="{{ url('admin/page/home/13') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="">Title</label>
                                    <input type="text" name="board_title" class="form-control" value="{{ $page_home->board_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Subtitle</label>
                                    <input type="text" name="board_subtitle" class="form-control" value="{{ $page_home->board_subtitle }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Status</label>
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="board_status" id="rr1" value="Show" @if($page_home->board_status == 'Show') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr1">Show</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="board_status" id="rr2" value="Hide" @if($page_home->board_status == 'Hide') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr2">Hide</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-14" role="tabpanel" aria-labelledby="v-pills-14-tab">
                            ...
                            <form action="{{ url('admin/page/home/14') }}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="">Title</label>
                                    <input type="text" name="document_title" class="form-control" value="{{ $page_home->document_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Subtitle</label>
                                    <input type="text" name="document_subtitle" class="form-control" value="{{ $page_home->document_subtitle }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Status</label>
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="document_status" id="rr1" value="Show" @if($page_home->document_status == 'Show') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr1">Show</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="document_status" id="rr2" value="Hide" @if($page_home->document_status == 'Hide') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr2">Hide</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-15" role="tabpanel" aria-labelledby="v-pills-15-tab">
                            <!-- Tab 15 -->
                            <form action="{{ url('admin/page/home/15') }}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label for="">Title</label>
                                    <input type="text" name="about_us_title" class="form-control" value="{{ $page_home->about_us_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Subtitle</label>
                                    <input type="text" name="about_us_subtitle" class="form-control" value="{{ $page_home->about_us_subtitle }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Status</label>
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="about_us_status" id="rr1" value="Show" @if($page_home->about_us_status == 'Show') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr1">Show</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="about_us_status" id="rr2" value="Hide" @if($page_home->about_us_status == 'Hide') checked @endif>
                                            <label class="form-check-label font-weight-normal" for="rr2">Hide</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade" id="v-pills-16" role="tabpanel" aria-labelledby="v-pills-16-tab">
                            ...
                            <form action="{{ url('admin/page/home/16') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="">Title</label>
                                    <input type="text" name="counter_title" class="form-control" value="{{ $page_home->counter_title }}">
                                </div>
                                <div class="form-group">
                                    <label for="">Subtitle</label>
                                    <input type="text" name="counter_subtitle" class="form-control" value="{{ $page_home->counter_subtitle }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Existing Background</label>
                                    <div><img src="{{ asset('public/uploads/'.$page_home->counter_bg) }}" alt="" class="w_200"></div>
                                </div>
                                <div class="form-group">
                                    <label for="">Change Background</label>
