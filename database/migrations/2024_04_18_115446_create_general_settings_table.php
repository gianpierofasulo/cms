...
return new class extends Migration
{
     ...
     public function up()
    {
        Schema::create('general_settings', function (Blueprint $table) {
            ...
            $table->text('google_adsense_script_code');
            $table->text('google_adsense_script_status');
            ...
            $table->text('banner_senior_detail')->nullable();
            $table->text('banner_board_detail')->nullable();
            $table->text('banner_developer_detail')->nullable();
            ...
            $table->text('banner_branch')->nullable();
            $table->text('banner_senior')->nullable();
            $table->text('banner_board')->nullable();
            $table->text('banner_job');
            $table->text('banner_job_application');
            $table->text('banner_term');
            $table->text('banner_privacy');
            $table->text('banner_document');
            $table->text('banner_ceo');
            $table->double('authorized_share')->nullable();
            $table->double('per_value')->nullable();
            $table->timestamps();
        });
    }
